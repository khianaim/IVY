  ...
  return (
    <div className="card-border w-full sm:w-[400px] md:w-[450px] min-h-[400px]">
      <div className="card-interview">
        <div>
        <div className="absolute top-0 right-0 w-fit px-4 py-2 bg-white/10 backdrop-blur-lg border border-white/10 shadow-2xl rounded-tr-2xl">
            <p className="badge-text">{normalizedType}</p>
          </div>

         {/* Interview Role */}
          <h3 className="mt-5 capitalize text-[#aecde6] font-extrabold">{role} Interview</h3>
        {/* Date & Score */}
