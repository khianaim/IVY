...
// Variable for elements in Hero Component for Motion
  ...
  <motion.div
    ...
    initial="hidden"
    animate="visible"
    className="flex flex-row justify-center gap-6 mt-2"
  >
    <button
    ...
    <Link href="/sign-up">
      ...
      {showInterview && (
        <motion.section
          ...
          className="absolute top-full left-0 w-full z-20 bg-black backdrop-blur-2xl shadow-2xl px-6 py-12 sm:px-12 md:px-20 lg:px-32 xl:px-40"
        >
            ...
            <form onSubmit={handleInterviewStart} className="space-y-6 text-white">
              ...
              <div>
                ...
                <input
                  ...
                  className="info mt-2 p-3 w-full rounded-lg bg-black/30 border border-white/20 backdrop-blur-md italic text-sm"
                  required
                />
              </div>
      ...
      {showInterviewModal && questions.length > 0 && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-transparent backdrop-blur-sm text-center p-6 rounded-l w-full max-w-3xl relative mt-4"
          >
            <button
